...
func (b *Builder) configureCache(cacheModule *Comp) {
	blockSize := 1 << (b.log2BlockSize + b.log2UnitSize)
	...
	directory := internal.NewDirectory(
		numSet, b.wayAssociativity, blockSize, b.log2BlockSize+b.log2UnitSize, vimctimFinder)
	...
	mshr := internal.NewMSHR(b.numMSHREntry, b.log2BlockSize+b.log2UnitSize)
	storage := mem.NewStorage(b.byteSize)

	cacheModule.log2PageSize = b.log2PageSize
	cacheModule.log2BlockSize = b.log2BlockSize + b.log2UnitSize
	cacheModule.log2SubBlockSize = b.log2BlockSize
