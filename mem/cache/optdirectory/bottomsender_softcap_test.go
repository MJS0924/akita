...
func TestOptTooManyInflightRequest_RemoteUnboundedWhenLocalIdle(t *testing.T) {
...
func TestOptTooManyInflightRequest_LocalCappedAtThreeQuarters(t *testing.T) {
	bs := &bottomSender{maxInflightRequest: 128}
	for i := 0; i < 95; i++ {
...
func TestOptTooManyInflightRequest_RemoteReserveProtected(t *testing.T) {
	bs := &bottomSender{maxInflightRequest: 128}
	for i := 0; i < 96; i++ {
		bs.localInflightRequest = append(bs.localInflightRequest, nil)
	}
